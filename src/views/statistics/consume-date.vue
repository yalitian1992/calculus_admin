<template>
  <div>
    <el-row :model="formDate">
      <el-col :span="4"><p class="add-txt">消耗总量：{{toMoney(del_value)}}</p></el-col>
      <el-col :span="6">
        <div class="block">
    ...
    <el-col :span="24">
      <a :href="del_totals.length == 0 ? 'javascript:void(0)':'http://10.0.1.87:8770/drp-management-web/account/exportExcelByAccountLog?'+this.paradate">
...
<script>
  export default {
    ...
    methods: {
      ...
      postUser(date){
        var _this = this;
        this.asyncHttp('post', '/drp-management-web/account/queryReduceAccountRecord',date, function (res) {
